...
export interface AutomatedTaskPolicy extends AutomatedTaskBase {
  policy: number;
  task_type: AgentTaskType;
  server_task: false;
}

export interface AutomatedTaskAgent extends AutomatedTaskBase {
  agent: number;
  task_type: AgentTaskType;
  server_task: false;
}

export interface AutomatedTaskServer extends AutomatedTaskBase {
...
export interface AutomatedTaskForDB {
  id: number;
  policy?: number;
  agent?: number;
  task_type: AgentTaskType;

<template>
  <div class="q-pb-sm">
    <q-bar>
      <q-btn-group flat>
        <q-btn size="md" dense no-caps flat label="Fichier">
          <q-menu>
            <q-list dense style="min-width: 100px">
              <q-item clickable>
                <q-item-section>Ajouter</q-item-section>
                <q-item-section side>
              ...
              <q-item clickable v-close-popup @click="showDebugLog">
                <q-item-section>Journal de débug</q-item-section>
              </q-item>
            </q-list>
          </q-menu>
        </q-btn>
        <!-- view -->
        <q-btn size="md" dense no-caps flat label="Vue">
          <q-menu auto-close>
            <q-list dense style="min-width: 100px">
              <q-item clickable v-close-popup @click="showPendingActions">
                <q-item-section>Actions en attente</q-item-section>
              </q-item>
            </q-list>
          </q-menu>
        </q-btn>
          ...
          <q-menu auto-close>
            <q-list dense style="min-width: 100px">
              <q-item clickable v-close-popup @click="showInstallAgent = true">
                <q-item-section>Installer un agent</q-item-section>
              </q-item>
              <q-item clickable v-close-popup @click="showDeployments">
                <q-item-section>Gérer les déploiements</q-item-section>
              </q-item>
              <q-item
                clickable
                v-close-popup
              ...
              >
                <q-item-section>Mise à jour des agents</q-item-section>
              </q-item>
            </q-list>
          </q-menu>
        </q-btn>
        ...
        <!-- settings -->
        <q-btn size="md" dense no-caps flat label="Paramètres">
          <q-menu auto-close>
            <q-list dense style="min-width: 100px">
              <!-- clients manager -->
              <q-item clickable v-close-popup @click="showClientsManager">
                <q-item-section>Gestion des clients</q-item-section>
              </q-item>
              <!-- script manager -->
              <q-item clickable v-close-popup @click="showScriptManager">
                <q-item-section>Gestion des scripts</q-item-section>
              </q-item>
              <!-- automation manager -->
              <q-item clickable v-close-popup @click="showAutomationManager">
                <q-item-section>Gestion de l'automate</q-item-section>
              </q-item>
              <!-- alerts manager -->
              <q-item clickable v-close-popup @click="showAlertsManager">
                <q-item-section>Gestion des alertes</q-item-section>
              </q-item>
              <!-- permissions manager -->
              <q-item clickable v-close-popup @click="showPermissionsManager">
                <q-item-section>Gestion des permissions</q-item-section>
              </q-item>
              <!-- admin manager -->
              <q-item clickable v-close-popup @click="showAdminManager = true">
                <q-item-section>Administration utilisateur</q-item-section>
              </q-item>
              <!-- core settings -->
              <q-item
                clickable
              ...
              >
                <q-item-section>Paramètres généraux</q-item-section>
              </q-item>
              <!-- code sign -->
              <q-item
                v-if="!hosted"
              ...
              >
                <q-item-section>Signature de code</q-item-section>
              </q-item>
            </q-list>
          </q-menu>
        </q-btn>
        <!-- tools -->
        <q-btn size="md" dense no-caps flat label="Outils">
          <q-menu auto-close>
            <q-list dense style="min-width: 100px">
              <!-- bulk command -->
              <q-item
        ...
        <!-- help -->
        <q-btn v-if="!hosted" size="md" dense no-caps flat label="Aide">
          <q-menu auto-close>
            <q-list dense style="min-width: 100px">
              ...
              <q-item clickable v-close-popup @click="openHelp('github')">
                <q-item-section> Repo GitHub</q-item-section>
              </q-item>
              ...
              <q-item clickable v-close-popup @click="openHelp('feature')">
                <q-item-section>Demande de fonctionnalité</q-item-section>
              </q-item>
              <q-item clickable v-close-popup @click="openHelp('discord')">
                <q-item-section>Nous rejoindre sur Discord</q-item-section>
              </q-item>
            </q-list>
          </q-menu>
        </q-btn>

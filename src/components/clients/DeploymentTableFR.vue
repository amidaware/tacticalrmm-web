        ...
        <template v-slot:body="props">
          ...
          >
            ...
            <q-td key="flags" :props="props"
              ><q-badge color="grey-8" label="Voir les balises" />
...
<script>
// composition imports
import { ref, computed, onMounted } from "view";
...
const columns = [
  ...
  { name: "flags", label: "Balises", field: "install_flags", align: "left" },
  { name: "link", label: "Lien de téléchargement", align: "left" },
];

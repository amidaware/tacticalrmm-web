<template>
  <q-dialog ref="dialogRef" @hide="onDialogHide">
    <q-card style="width: 40vw">
      ...
      <q-card-section>
        <div class="q-pl-sm">Type d'agent</div>
        <q-radio
      ...
      <q-card-section class="q-gutter-sm">
        <q-checkbox v-model="state.rdp" dense label="Activer le RDP" />
        <q-checkbox v-model="state.ping" dense label="Activer le Ping" />
        <q-checkbox
          v-model="state.power"
          dense

          ...
          <template v-slot:before>
            <div class="row">
              <q-tabs
                ...
                narrow-indicator
              >
                <q-tab name="server" icon="fas fa-server" label="Serveurs" />
                <q-tab
                  name="workstation"
                  icon="computer"
                  label="Ordinateurs"
                />
                <q-tab name="mixed" label="Tous" />
              </q-tabs>
              <q-space />
              <q-input
                v-model="search"
              ...
              >
                ...
                <template v-slot:after>
                  ...
                  >
                    <q-menu>
                      <q-list dense>
                        <q-item-label header>Filtre sur agent</q-item-label>
